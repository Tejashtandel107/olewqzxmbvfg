...
class ClientDeletedNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject(__('Client account deleted'))
                    ->line(__("A client account has been deleted by the :auth_role :auth_email. The details are as below.",["auth_role"=>$auth_role_name,"auth_email"=>$this->auth_user->email]))
