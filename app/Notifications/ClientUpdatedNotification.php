...
class ClientUpdatedNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject(__('Client account updated'))
                    ->line(__("A new client account has been updated by the :auth_role :auth_email. The details are as below.",["auth_role"=>$auth_role_name,"auth_email"=>$this->auth_user->email]))
