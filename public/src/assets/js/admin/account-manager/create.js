...
$(function() {
    ...
    form_api.init($("#account-managers-form"));
...
function formResponse(responseText, statusText) {
    var caption = "Account manager aggiornato con successo.";
    
    if(form_api.getFormMethod() === 'post')
    {
        caption = "Account manager creato con successo.";
        form_api.$form[0].reset();
    }

    $("#submitbtn").btnSpinner({disabled:false});
    $("#notify").notification({caption: caption, type:"success", sticky:false});
    $("#account-managers-form img").attr("src",responseText.data.photo);
}