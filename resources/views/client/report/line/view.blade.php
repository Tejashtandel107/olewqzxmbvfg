    ...
    <div class="card-body table-responsive">
        ...
        <div class="row justify-content-between mb-3 gap-3">
            <div class="col-sm-auto">
                {{ Form::model($request,array('url' =>route("client.reports.lines"),'method'=>'get','id'=>'form-filter')) }} 
            ...
            <div class="col-auto align-self-center">
                <a class="btn btn-secondary text-xl-end" href="{{route('client.reports.lines',['download' => '1','company_id' => $request->company_id,'from_date' => $request->from_date,'to_date' => $request->to_date])}}"><i class="ri-file-excel-2-fill me-1 align-middle"></i><span class="align-middle">Esportare</span></a>    
            </div>
        </div>
