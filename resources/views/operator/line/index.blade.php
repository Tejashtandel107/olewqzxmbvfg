    ...
    <div class="card">
        <div class="card-body table-responsive">
            ...
            <div class="d-flex flex-wrap mb-2 justify-content-between">
                <div>
                    {{ Form::model($request,array('url' =>route('operator.lines.index'),'method'=>'get','id'=>'form-filter')) }} 
                ...
                <div class="align-self-end">
                    <div class="text-xl-end mt-3">
                        <a href="{{ route('operator.lines.create') }}"><x-primary-button><i class="mdi mdi-plus me-1"></i>{{__('Add New')}}</x-primary-button></a>
                    </div>
                </div>
            </div>
            <div class="row">
...
@section('page-scripts')
    <script src="{{ asset('/assets/js/operator/line/index.min.js') }}"></script>
@endsection
</x-app-layout>
