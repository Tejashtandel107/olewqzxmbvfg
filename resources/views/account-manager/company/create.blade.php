<x-app-layout :breadcrumbs="$breadcrumbs" :pagetitle="$pagetitle">
    ...
    <div class=card>
        ...
        <div class="card-footer border-top border-light">
            ...
            <a href="{{route('account-manager.companies.index')}}" class="btn btn-outline-secondary">{{__('Cancel')}}</a>
...
@section('page-scripts')
    <script src="{{ asset('/assets/js/account-manager/company/create.min.js') }}"></script>
@endsection
</x-app-layout>