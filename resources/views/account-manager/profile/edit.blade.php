<x-app-layout :breadcrumbs="$breadcrumbs" :pagetitle="$pagetitle">
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <form method="post" action="{{ route('account-manager.profile.update') }}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="card-body">
...
<script src="{{asset('/assets/js/account-manager/profile/create.min.js')}}"></script>
@endsection
</x-app-layout>
