...
@endsection
    <div class="card">
        <div class="card-body">
            <div>
                {{ Form::model($request,array('url' =>route("account-manager.line-incomes.index"),'method'=>'get','id'=>'form-filter')) }} 
            ...
            <?php $detailReportURL = route('account-manager.reports.lines'); ?>
