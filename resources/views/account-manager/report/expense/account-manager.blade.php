...
@endsection
    <div class="card">
        <div class="card-body">
            <div>
                {{ Form::model($request,array('url' =>route("account-manager.line-expenses.index"),'method'=>'get','id'=>'form-filter')) }} 
            ...
            <x-line-expense-account-manager-monthly className="text-success" :lineExpensesMonthly="$lineExpensesMonthly"></x-line-expense-account-manager-monthly>
        </div>
        <!-- end card body-->
    </div>  
