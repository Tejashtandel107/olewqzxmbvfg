    ...
    <div class="card">
        <div class="card-body table-responsive">
            ...
            <div class="row justify-content-between mb-3 gap-3">
                <div>
                    {{ Form::model($request,array('url' =>route("admin.reports.lines.team"),'method'=>'get','id'=>'form-filter')) }} 
                    ...
                    <div class="d-flex gap-3 flex-wrap flex-sm-row flex-column">
                        ...
                        <div class="form-control-width">
                            {{ Form::label('account-manager-id', __('Team'), ['class' => 'form-label']); }}
        ...
        @if (isset($lineTotals) && $lineTotals->count()>0)
            <x-report-lines-team :lineTotals="$lineTotals"></x-report-lines-team>
        @else
